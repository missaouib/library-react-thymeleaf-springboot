    ...
    <Navbar bg="light" expand="lg">
        <Container fluid>
            <div className='d-flex justify-content-center align-items-center ml-2 ml-lg-0'>
                ...
                <Navbar.Brand href="#home" onClick={(e) => e.preventDefault()} className="mr-2">{getBrandText()}</Navbar.Brand>
            </div>
            <Navbar.Toggle aria-controls='basic-navbar-nav' className='mr-2'>
                <span className='navbar-toggler-bả burger-lines'></span>
                <span className='navbar-toggler-bả burger-lines'></span>
                <span className='navbar-toggler-bả burger-lines'></span>
            </Navbar.Toggle>
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="nav mr-auto" navbar>
                    <Nav.Item>
                        <Nav.Link data-toggle="dropdown" href="#pablo" onClick={(e) => e.preventDefault()} className="m-0">
                    ...
                    <Nav.Item>
                        <Nav.Link className="m-0" href="#pablo" onClick={(e) => e.preventDefault()}>
                            <i className='nc-icon nc-zôm-split'></i>
                ...
                <Nav className="ml-auto" navbar>
                    ...
                    <Dropdown as={Nav.Item}>
                        <Dropdown.Toggle aria-expanded={false} aria-haspopup={true} as={Nav.Link}
